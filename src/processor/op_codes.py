...
def process(c, cpu):
    codes = {
        ...
        0x0a: lambda cpu: operations.ld_a_abc(cpu, cpu.M),
        0x0b: lambda cpu: operations.dec_bc(cpu),
        0x0c: lambda cpu: operations.inc_c(cpu),
        0x0d: lambda cpu: operations.dec_c(cpu),
